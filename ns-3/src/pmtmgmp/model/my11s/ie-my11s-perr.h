...
public:
  ...
  void AddAddressUnit (PmtmgmpProtocol::FailedDestination unit);
  bool IsFull () const;
  std::vector<PmtmgmpProtocol::FailedDestination> GetAddressUnitVector () const;
...
private:
  std::vector<PmtmgmpProtocol::FailedDestination> m_addressUnits;
