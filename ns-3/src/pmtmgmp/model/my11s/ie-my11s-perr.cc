  ...
  for (unsigned int j = 0; j < numOfDest; j++)
    {
      ...
      PmtmgmpProtocol::FailedDestination unit;
...
void
IePerr::AddAddressUnit (PmtmgmpProtocol::FailedDestination unit)
{
...
{
  for (std::vector<PmtmgmpProtocol::FailedDestination>::iterator i = m_addressUnits.begin (); i
