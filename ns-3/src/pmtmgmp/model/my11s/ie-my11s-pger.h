...
#ifndef PMTMGMP_WIFI_PGER_INFORMATION_ELEMENT_H
#define PMTMGMP_WIFI_PGER_INFORMATION_ELEMENT_H
...
namespace ns3 {
	namespace my11s {
		class IePger : public WifiInformationElement
		{
		public:
			IePger();
			~IePger();
		...
		private:
			...
			friend bool operator== (const IePger & a, const IePger & b);

		};
		bool operator== (const IePger & a, const IePger & b);
		std::ostream &operator << (std::ostream &os, const IePger &secreq);
	}
}
#endif
#endif