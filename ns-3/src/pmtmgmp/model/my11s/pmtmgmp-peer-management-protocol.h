...
#ifndef MY11S_PMTMGMP_PEER_MAN_H
#define MY11S_PMTMGMP_PEER_MAN_H
...
#include "ie-my11s-beacon-timing.h"
#include "ie-my11s-peer-management.h"
#include "pmtmgmp-peer-link.h"
...
public:
   ...
   * \param peerWmnPointAddress is address of peer wmn point device (equal
  ...
  /**
   * \brief Cancels peer link due to broken configuration (Wmn ID or Supported
   * rates)
   */
...
private:
  ...
  /**
   * \name External pmtmgmp-peer-chooser
   * \{
   */
...
private:
   ...
   * Mac48Address is peer address of wmn point,
