...
#ifndef WMN_WIFI_INTERFACE_MAC_PLUGIN_H
#define WMN_WIFI_INTERFACE_MAC_PLUGIN_H
 ...
 * \ingroup wmn
 * 
 * \brief Common interface for wmn point interface MAC plugins
 * 
 * \todo plugins description
 */
class WmnWifiInterfaceMacPlugin : public SimpleRefCount<WmnWifiInterfaceMacPlugin>
{
public:
  /// This is for subclasses
  virtual ~WmnWifiInterfaceMacPlugin (){};
  /// Each plugin must be installed on interface to work 
  virtual void SetParent (Ptr<WmnWifiInterfaceMac> parent) = 0; 
  /** 
   ...
   * \todo define when MAC call this
   */
  virtual void UpdateBeacon (WmnWifiBeacon & beacon) const = 0;
  /**
...
#endif /* WMN_WIFI_INTERFACE_MAC_PLUGIN_H */
