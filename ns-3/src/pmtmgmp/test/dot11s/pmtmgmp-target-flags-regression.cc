...
const char * const PREFIX = "pmtmgmp-target-flags-regression-test";


PmtmgmpDoRfRegressionTest::PmtmgmpDoRfRegressionTest () : TestCase ("PMTMGMP target flags regression test"),
                                                    m_nodes (0),
                                                    m_time (Seconds (5))
{
}

PmtmgmpDoRfRegressionTest::~PmtmgmpDoRfRegressionTest ()
{
  delete m_nodes;
}
void
PmtmgmpDoRfRegressionTest::DoRun ()
{
...
void
PmtmgmpDoRfRegressionTest::CreateNodes ()
{
...
void
PmtmgmpDoRfRegressionTest::InstallApplications ()
{
...
void
PmtmgmpDoRfRegressionTest::CreateDevices ()
{
...
void
PmtmgmpDoRfRegressionTest::CheckResults ()
{
  for (int i = 0; i < 4; ++i)
    {
